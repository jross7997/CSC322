//Lab1
//A basic calculator that adds, subtracts, multiplies, and divides floating point numbers.
//It also performs the collatz conjecture on integers.
//
//Author: Justin Ross
...
//Bye Branch
			//check if the user wrote "bye"
				...
				//count if there was two floats typed in
				count = sscanf(str,"%s %s",com, extra);
